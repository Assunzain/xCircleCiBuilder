...
wget https://github.com/ZyCromerZ/Clang/releases/download/14.0.0-20220202-release/Clang-14.0.0-20220202.tar.gz
mkdir clang
tar zxvf Clang-14.0.0-20220202.tar.gz -C clang
...
export KBUILD_BUILD_HOST=ThankYou # Change with your own hostname.
