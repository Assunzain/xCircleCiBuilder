...
wget https://github.com/ZyCromerZ/Clang/releases/download/15.0.0-20220203-release/Clang-15.0.0-20220203.tar.gz
mkdir clang
tar zxvf Clang-15.0.0-20220203.tar.gz -C clang
